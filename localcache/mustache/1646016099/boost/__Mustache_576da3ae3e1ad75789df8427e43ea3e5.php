...
class __Mustache_576da3ae3e1ad75789df8427e43ea3e5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div tabindex="0" class="file-picker fp-generallayout container-fluid row" role="dialog" aria-live="assertive">
';
        $buffer .= $indent . '    <div class="fp-repo-area col-md-3 nav nav-pills nav-stacked" role="tablist">
';
        $buffer .= $indent . '            <div class="fp-repo nav-item" role="tab" aria-selected="false" tabindex="-1">
';
        $buffer .= $indent . '                <a href="#" class="nav-link" tabindex="-1"><img class="fp-repo-icon" alt=" " src="#" width="16" height="16" />&nbsp;<span class="fp-repo-name"></span></a>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '
...
';
        $buffer .= $indent . '            <div class="fp-navbar bg-faded card m-b-0 clearfix icon-no-spacing">
';
        $buffer .= $indent . '                <div>
';
...
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                    <div class="fp-viewbar btn-group pull-xs-right">
';
